...
//                         px-4 sm:px-8 py-4 border-b border-gray-800 gap-4">
//           {/* Welcome */}
//           <div>
...
//             <button
//               onClick={logout}
//               className="px-3 sm:px-4 py-2 bg-red-600 rounded
//                          hover:bg-red-700 text-sm cursor-pointer transition"
//             >
//               Logout
//             </button>
//           </div>
...
//               className="bg-[#111827] border border-[#1f2937] rounded-xl p-5 sm:p-6
//                          cursor-pointer hover:border-blue-500
//                          hover:shadow-blue-500/20 hover:shadow-xl transition"
//             >
